...
locals {
  ...
  iso_sha_amd64    = "file:https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/SHA256SUMS"
  ...
  iso_sha_arm64    = "file:https://cdimage.debian.org/debian-cd/current/arm64/iso-cd/SHA256SUMS"
